...
export default function DashboardPage() {
  ...
  const quotations = quoteData?.quotes ?? [];
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        description="Bienvenido a tu cuenta de Merkley Details"
      />
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="mt-1 text-xs text-muted">Total de cotizaciones</p>
          </CardContent>
        </Card>
            ...
            <p className="mt-1 text-xs text-muted">
              {invoicesLoading
                ...
                : pendingInvoices.length > 0
                  ? `${formatCurrency(pendingInvoices.reduce((sum, inv) => sum + inv.outstanding_amount, 0))} pendiente`
                  : "Al día"}
            </p>
          </CardContent>
        </Card>
                  ...
                  return (
                    <div key={quote.name}>
                      <Link
                        ...
                        className="flex items-center justify-between rounded-lg px-3 py-3 transition-colors hover:bg-surface-muted"
                      >
