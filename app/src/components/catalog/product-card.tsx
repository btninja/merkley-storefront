      ...
      <Card className="h-full overflow-hidden transition-shadow hover:shadow-md">
        ...
        <CardContent className="p-4">
          ...
          <div className="mt-3 flex items-center gap-2">
            ...
            <Button
              size="icon"
              className="ml-auto h-9 w-9 sm:h-7 sm:w-7 shrink-0 rounded-full shadow-sm transition-all [@media(hover:hover)]:opacity-0 [@media(hover:hover)]:group-hover:opacity-100"
